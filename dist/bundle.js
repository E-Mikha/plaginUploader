...
/* harmony import */ var _upload_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./upload.js */ "./upload.js");
...
(0,_upload_js__WEBPACK_IMPORTED_MODULE_2__.upload)("#file", {
  multi: true,
  accept: [".png", ".jpg", ".jpeg", ".gif", ".svg"],
  onUpload(files, blocks) {
    files.forEach((file, index) => {
      const storageRef = (0,firebase_storage__WEBPACK_IMPORTED_MODULE_1__.ref)(storage, `images/${file.name}`);
